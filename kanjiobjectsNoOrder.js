...
const objectsArray = [
    {cardNumber: "1", kanji: "沸", hiragana: "わかす・わく・ふつ", english: "to boil", example1: "やかんで水を沸かす", example2: "お湯が沸いている", jishoLink: "https://jisho.org/search/%E6%B2%B8", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU6CB8", moreExamples: multiExample1},
    {cardNumber: "2", kanji: "需", hiragana: "じゅ", english: "demand - request", example1: "需要が高まっている", example2: "需給の調整には慎重な計画が必要", jishoLink:"https://jisho.org/search/%E9%9C%80", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU9700", moreExamples: multiExample2},
    {cardNumber: "3", kanji: "腫", hiragana: "しゅ・はれる", english: "tumor - swelling", example1: "彼女は腫瘍の手術を受けた", example2: "顔が腫れている", jishoLink:"https://jisho.org/search/%E8%85%AB", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU816B", moreExamples: multiExample3},
    {cardNumber: "4", kanji: "疾", hiragana: "しつ", english: "rapidly", example1: "疾患", example2: "疾病", jishoLink:"https://jisho.org/search/%E7%96%BE", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU75BE", moreExamples: multiExample4},
    {cardNumber: "5", kanji: "匿", hiragana: "かくす・かくれる・とく", english: "hide - shelter", example1: "プレゼントを隠す", example2: "彼は木の後ろに隠れた", jishoLink:"https://jisho.org/search/%E5%8C%BF", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU533F", moreExamples: multiExample5},
    {cardNumber: "6", kanji: "紺", hiragana: "こん", english: "dark blue - navy", example1: "彼は紺色のバッグを持っています", example2: "紺四郎", jishoLink:"https://jisho.org/search/%E7%B4%BA", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU7D3A", moreExamples: multiExample6},
    {cardNumber: "7", kanji: "帽", hiragana: "ぼう", english: "cap - headgear", example1: "帽子を取る", example2: "帽子屋", jishoLink:"https://jisho.org/search/%E5%B8%BD", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU5E3D", moreExamples: multiExample7},
    {cardNumber: "8", kanji: "鼓", hiragana: "つづみ・こ", english: "hand drum - beat", example1: "鼓動", example2: "鼓膜", jishoLink:"https://jisho.org/search/%E9%BC%93", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU9F13", moreExamples: multiExample8},
    {cardNumber: "9", kanji: "潤", hiragana: "うるおい・じゅん", english: "wet - moisture", example1: "この場所は潤いがある", example2: "潤滑油", jishoLink:"https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU6F64", jimLink: "https://jisho.org/search/%E6%BD%A4", moreExamples: multiExample9},
    {cardNumber: "10", kanji: "宴", hiragana: "うたげ・えん", english: "feast", example1: "宴で盛り上げる", example2: "宴会が楽しかったです", jishoLink:"https://jisho.org/search/%E5%AE%B4", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU5BB4", moreExamples: multiExample10},
    {cardNumber: "11", kanji: "貢", hiragana: "こう", english: "finance", example1: "貢献", example2: "貢納", jishoLink:"https://jisho.org/search/%E8%B2%A2", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU8CA2", moreExamples: multiExample11},
    {cardNumber: "12", kanji: "痩", hiragana: "やせる・そう", english: "to get thin", example1: "痩せるために運動する", example2: "痩身", jishoLink:"https://jisho.org/search/%E7%97%A9", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU75E9", moreExamples: multiExample12},
    {cardNumber: "13", kanji: "恩", hiragana: "おん", english: "grace - kindness", example1: "彼の恩恵に助けられました", example2: "政府は恩赦を発表しました", jishoLink:"https://jisho.org/search/%E6%81%A9", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU6069", moreExamples: multiExample13},
    {cardNumber: "14", kanji: "謀", hiragana: "はかる・ぼう", english: "to conspire - devise", example1: "彼は計画を謀りました", example2: "謀議", jishoLink:"https://jisho.org/search/%E8%AC%80", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU8B00", moreExamples: multiExample14},
    {cardNumber: "15", kanji: "旋", hiragana: "せん", english: "rotation", example1: "旋律を歌う", example2: "旋風に巻き込まれる", jishoLink:"https://jisho.org/search/%E6%97%8B", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU65CB", moreExamples: multiExample15},
    {cardNumber: "16", kanji: "盾", hiragana: "たて", english: "shield", example1: "盾を構える", example2: "楯突く", jishoLink:"https://jisho.org/search/%E7%9B%BE", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU76FE", moreExamples: multiExample16},
    {cardNumber: "17", kanji: "寮", hiragana: "りょう", english: "hostel - dorm", example1: "寮での規則を守る", example2: "寮の仲間と食事を共にする", jishoLink:"https://jisho.org/search/%E5%AF%AE", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU5BEE", moreExamples: multiExample17},
    {cardNumber: "18", kanji: "刃", hiragana: "は・やいば", english: "sword", example1: "刃物を使って果物を切る", example2: "刃を鍛える", jishoLink:"https://jisho.org/search/%E5%88%83", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU5203", moreExamples: multiExample18},
    {cardNumber: "19", kanji: "啓", hiragana: "けい", english: "disclose - say", example1: "啓発活動を行う", example2: "啓蒙活動を支援", jishoLink:"https://jisho.org/search/%E5%95%93", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU5553", moreExamples: multiExample19},
    {cardNumber: "20", kanji: "誉", hiragana: "ほめる・ほまれ", english: "honor - glory", example1: "褒め言葉は心を温める", example2: "その行為には大いなる誉れがある", jishoLink:"https://jisho.org/search/%E8%AA%89", jimLink: "https://www.edrdg.org/cgi-bin/wwwjdic/wwwjdic?1MKU8A89", moreExamples: multiExample20},];
...
document.getElementById('deckButton').addEventListener("click", function() {
    ...
    deckWindow.classList.toggle('open'); deckWindow.style.display = deckWindow.classList.contains('open') ? 'block' : 'none';});
document.getElementById('deckMinimize').addEventListener("click", function(){
    const deckWindow = document.getElementById('deckWindow');
    deckWindow.classList.remove('open');
    deckWindow.classList.add('close');
    setTimeout(function() {deckWindow.style.display = "none";deckWindow.classList.remove('close');}, 500);});
...
document.addEventListener("keydown", function (event) {
    if (event.key === "e" || event.key === "E"){
        document.getElementById("tenExamplesButton").click();}});        
document.addEventListener("keydown", function (event) { 
